...
// client의 request mathod
// requestMethod = GET 선어한 함수

// 익명, 무명함수
// function(req,res) 함수는 함수인데 이름이 없는 함수
// 함수라는 선언만 있고 이름이 없는 함수
// client에서 /로 요청을 하면 처리할 코드를 포함하는곳
// call back 함수라고 한다
// url에 의해서 호출되는 mapping
// localhost:3000/home요청에 
...
// 현재 이파일에서 설정한 router 객체를 다른 js 파일에서 import하여 사용할수있도록 설정
